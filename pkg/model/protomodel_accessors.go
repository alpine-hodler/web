...
// WireDepositInformation converts the native protomodel ProtoWireDepositInformation to a local
...
// SwiftDepositInformation converts the native protomodel ProtoSwiftDepositInformation to a local
...
// SepaDepositInformation converts the native protomodel ProtoSepaDepositInformation to a local
...
// UkDepositInformation converts the native protomodel ProtoUkDepositInformation to a local
