...
type BookmarksOptions struct {
	...
	Expansions *Expansions `json:"expansions" bson:"expansions"`
	...
	MaxResults *uint8 `json:"max_results" bson:"max_results"`
	...
	MediaFields *MediaFields `json:"media.fields" bson:"media.fields"`
	...
	PaginationToken *string `json:"pagination_token" bson:"pagination_token"`
	...
	// fields in the includes data object.
	PlaceFields *PlaceFields `json:"place.fields" bson:"place.fields"`
	...
	PollFields *PollFields `json:"poll.fields" bson:"poll.fields"`
	...
	TweetFields *TweetFields `json:"tweet.fields" bson:"tweet.fields"`
	...
	UserFields *UserFields `json:"user.fields" bson:"user.fields"`
}
