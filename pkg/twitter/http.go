...
func (c *Client) AllTweets(opts *AllTweetsOptions) (m *Tweets, _ error) {
	...
	return m, internal.HTTPFetch(http.Client(*c), req, opts, AllTweetsPath, nil, &m)
}
...
func (c *Client) Bookmarks(userId string, opts *BookmarksOptions) (m *Bookmarks, _ error) {
	req, _ := internal.HTTPNewRequest("GET", "", opts)
	return m, internal.HTTPFetch(http.Client(*c), req, opts, BookmarksPath, map[string]string{
		"user_id": userId,
	}, &m)
}
...
func (c *Client) ComplianceJobs(opts *ComplianceJobsOptions) (m []*Compliance, _ error) {
	req, _ := internal.HTTPNewRequest("GET", "", opts)
	return m, internal.HTTPFetch(http.Client(*c), req, opts, ComplianceJobsPath, nil, &m)
}
...
func (c *Client) CreateBookmark(userId string, opts *CreateBookmarkOptions) (m BookmarkWrite, _ error) {
	...
	return m, internal.HTTPFetch(http.Client(*c), req, nil, CreateBookmarkPath, map[string]string{
		"user_id": userId,
	}, &m)
}
...
func (c *Client) DeleteBookmark(userId string, tweetId string) (m BookmarkWrite, _ error) {
	...
	return m, internal.HTTPFetch(http.Client(*c), req, nil, DeleteBookmarkPath, map[string]string{
...
func (c *Client) Me() (m []*User, _ error) {
	...
	return m, internal.HTTPFetch(http.Client(*c), req, nil, MePath, nil, &m)
}
...
func (c *Client) Tweets(opts *TweetsOptions) (m *Tweets, _ error) {
	req, _ := internal.HTTPNewRequest("GET", "", opts)
	return m, internal.HTTPFetch(http.Client(*c), req, opts, TweetsPath, nil, &m)
}
