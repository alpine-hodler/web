...
type CoinbaseWallet struct {
	...
	ProtoSepaDepositInformation  CoinbaseSepaDepositInformation  `json:"sepa_deposit_information" bson:"sepa_deposit_information"`
	ProtoSwiftDepositInformation CoinbaseSwiftDepositInformation `json:"swift_deposit_information" bson:"swift_deposit_information"`
	ProtoUkDepositInformation    CoinbaseUkDepositInformation    `json:"uk_deposit_information" bson:"uk_deposit_information"`
	ProtoWireDepositInformation  CoinbaseWireDepositInformation  `json:"wire_deposit_information" bson:"wire_deposit_information"`
